        ...
        reports = [
            ...
            },
            {
                ...
                'описание': (
                    ...
                    'В случае отсутствия отчета - вся задолженность короткая.'
                ),
            ...
            },
            {
                ...
                'описание': (
                    ...
                    'В случае отсутствия отчета - вся задолженность как неинвестиционная.'
                ),
                'Обязательность': 'для УПП - да',
            },
            {
                ...
                'описание': (
                    ...
                    'В случае отсутствия отчета - все РБП короткая часть.'
                ),
                'Обязательность': 'для УПП - да',
            },
        ]
